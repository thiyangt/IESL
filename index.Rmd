...
<div style="border: 2px solid ##feb24c; padding: 20px; width: 80%; margin: auto; background-color: #49006a; font-size: 27px; color: white; font-weight: bold;">
...
final_data |> 
  ...
  knitr::kable(col.names = c("Species", "Mean Stress (MPa)", "Standard Deviation (MPa)")) |>
  kable_styling(font_size = 30)
```
]
...
#               color = "black", vjust = -1, size = 5) +  
  labs(x = "Species", y = "Stress (MPa)", col = "Species") +  
